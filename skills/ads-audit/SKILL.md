...
Follow the **MCP Server Detection** section above. If no MCP server is found, guide the user through setup before proceeding. Wait for the user to complete setup before continuing.
